...
export default function SuksesKeluar() {
    return (
        <section className="mx-auto" style={{ backgroundColor: "#269544", height: "auto", maxWidth: "376px"}}>
            <Header />
            <div style={{ display: "flex", flexDirection: "column", justifyContent: "space-between", height: "90vh"}}>
                ...
                <div className="home" style={{ display: "flex", flexDirection: "column", justifyContent: "end", height: "50vh", gap: "15vh" }}>
