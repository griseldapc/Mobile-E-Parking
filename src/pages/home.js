        ...
        <section className="mx-auto">
            ...
            <div className="home mx-auto" style={{ backgroundColor: "#F0F2F5", maxWidth: "376px", margin: "auto", paddingTop: "70px" }}>
                ...
                <div className="mt-3 d-flex justify-content-between"  style={{gap: "15px"}}>
                    <div className="tk" style={{ border: "1px solid #269544", borderRadius: "10px",width: "100%", backgroundColor: "rgba(81, 180, 108, 0.2)", padding: "15px" }}>
                    ...
                    <div className="tk" style={{ border: "1.5px solid #EDD6D6", borderRadius: "10px",width: "100%", backgroundColor: "#F7EEEE", padding: "15px"  }}>
