...
export default function TidakSesuai() {
    ...
    return (
        <section className="mx-auto" style={{ maxWidth: "376px", maxHeight: "100vh" }}>
            ...
            <div style={{ backgroundColor: "#F0F2F5", height: "100%" }} className="home">
                <form>
                    <div class="mb-3">
                ...
                <div style={{ display: "flex", flexDirection: "column", justifyContent: "space-between", height: "70vh" }}>
                    <div>
                                ...
                                <label htmlFor="upload-input-1" className='upload-input' style={{ position: "absolute", top: "0", left: "0", width: "100%", height: "100%" }}>
                                    ...
                                    {!previewImage1 && (
                                        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", width: "100%", height: "100%", padding: "10px" }}>
                                            ...
                                            <p style={{ fontSize: "11px", color: "#606060", fontWeight: "400", textAlign: "center" }}>Ambil foto Pengambil</p>
                                        </div>
                                    )}
                                </label>
                            ...
                            <div className="doc" style={{ border: "2px solid #606060", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", textAlign: "center", position: "relative", overflow: "hidden", padding: "10px" }}>
                                <label htmlFor="upload-input-2" className='upload-input' style={{ position: "absolute", top: "0", left: "0", width: "100%", height: "100%" }}>
                                    ...
                                    {!previewImage2 && (
                                        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", width: "100%", height: "100%", padding: "10px" }}>
                                            <img src="../../assets/Camera.svg" alt="Camera" />
                                            <p style={{ fontSize: "11px", color: "#606060", fontWeight: "400", textAlign: "center", width: "auto" }}>Ambil foto Scan KTP</p>
                                        </div>
                                    )}
                                </label>
                    ...
                    <Link to="/sukses">
                        <button style={{ backgroundColor: "#269544", borderRadius: "10px", width: "100%", height: "39px", fontSize: "12px", fontWeight: "bold", border: "none", color: "white" }} className="">KIRIM</button>
                    </Link>
                </div>
